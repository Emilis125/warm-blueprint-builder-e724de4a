      ...
      <>
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-40 animate-fade-in-up" style={{ width: 'min(380px, calc(100% - 48px))' }}>
          <div className="rounded-2xl px-4 py-3 flex items-center gap-3" style={{
            ...
            <button onClick={() => setSheetOpen(true)} className="shrink-0 px-3 py-1.5 rounded-lg text-[12px] font-bold" style={{ background: '#0A84FF', color: 'white' }}>
              Upgrade
            </button>
    ...
    <>
      <div className="rounded-2xl overflow-hidden" style={{
        ...
        <div className="px-4 pb-4">
          ...
          <button onClick={() => setSheetOpen(true)} className="mt-2 text-[11px] font-medium flex items-center gap-1" style={{ color: '#0A84FF' }}>
